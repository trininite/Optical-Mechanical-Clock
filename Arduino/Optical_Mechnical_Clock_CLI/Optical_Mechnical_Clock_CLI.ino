...
float Rref = 1000;          // Reference resistor's value in ohms (you can give this value in kiloohms or megaohms - the resistance of the >
float R = 1000000;               // Tested resistors default value
int clk = 0;
int ticks;
String Dout;
